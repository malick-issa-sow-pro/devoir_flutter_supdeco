              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                        openOptions.value > 0 ? '' : 'Toucher pour payer / demander',
                        style: TextStyle(fontSize: 10)),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Demande d’argent rapide'),
                  ),
                  Flexible(
                      child: Center(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.symmetric(vertical: 8.0),
                                child: Text('10 % de réduction sur tous les produits Pizzahut',
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 10.0,
                                    )),
