...
class _ShopBottomSheetState extends State<ShopBottomSheet> {
  List<Product> products = [
    Product('assets/headphones.png', 'Bluetooth ', 'description', 45.3),
    Product('assets/headphones_2.png', 'Casque', 'description', 22.3),
    Product('assets/headphones_3.png', 'Bluetooth', 'description', 58.3)
  ];
