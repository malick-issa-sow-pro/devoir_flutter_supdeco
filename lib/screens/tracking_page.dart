...
class _TrackingPageState extends State<TrackingPage> {
  ...
  String selectedProduct = 'Amplificateur de basses pour écouteurs de bateau 100v';
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          items: <String>[
                            'Casque pour bateau Bass Boost 100v',
                            'Casque pour bateau Bass Boost 200v',
                            'Casque pour bateau Bass Boost 300v',
                            'Casque pour bateau Bass Boost 400v',
                            'Casque pour bateau Bass Boost 500v',
                            'Casque pour bateau Double boosting des basses 600v'
                          ].map((val) {
