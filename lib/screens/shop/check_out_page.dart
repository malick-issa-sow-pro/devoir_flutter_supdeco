...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('assets/headphones.png', 'Casque 1', 'description', 45.3),
    Product('assets/headphones_2.png', 'Casque 2', 'description', 22.3),
    Product('assets/headphones_3.png', 'Casque 3', 'description', 58.3)
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Vérifier',
          style: TextStyle(
              color: darkGrey, fontWeight: FontWeight.w500, fontSize: 12.0),
        ),
      ),
      body: LayoutBuilder(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        products.length.toString() + ' articles',
                        style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 16),
